// import { ChartType, ChartDataGenStatus } from "../provider/chart/ChartDataFactory";
...
//         const cacheKey = CacheKeys.RawDataGenExecFlagPrefix.key + type + ':' + range;
//         const ttl = CacheKeys.RawDataGenExecFlagPrefix.ttl;
